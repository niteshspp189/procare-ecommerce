            ...
            <div style={s.content}>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 mb-12 lg:mb-20">
                    <div className="space-y-8 lg:space-y-12">
                        ...
                        <div className="bg-gradient-to-br from-teal-50 to-teal-100/50 border border-teal-200 text-gray-800 p-6 lg:p-8 rounded-2xl relative overflow-hidden shadow-sm">
                            <div className="flex items-center gap-3 mb-4">
                                <div className="w-10 h-10 rounded-full bg-[#0bb799] flex items-center justify-center text-white shadow-md">
                                ...
                                <h3 className="text-xl font-black uppercase tracking-tight">Live Support</h3>
                            </div>
                            <p className="text-gray-600 mb-6 text-sm leading-relaxed font-medium">Need immediate help with an order or have a product question? Our dedicated support team is available during working hours.</p>
                            <a
                                href="https://wa.me/919958410042"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-full flex items-center justify-center gap-2 bg-[#0bb799] text-white font-bold py-3.5 rounded-xl hover:bg-[#099980] hover:-translate-y-0.5 transition-all uppercase tracking-wider text-xs shadow-md hover:shadow-lg"
                            >
                                Chat on WhatsApp
                            </a>
                        </div>
