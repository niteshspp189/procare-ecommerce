...
export default async function StagingHome(props: {
  ...
  return (
    <div style={s.container} className="animate-fade-in font-sans">
      {/* HERO SECTION */}
      <div className="relative overflow-hidden group min-h-[450px] md:min-h-[600px] flex items-center justify-center bg-[#ffffff]">
      ...
      <div className="w-full">
        ...
        {/* CATEGORY GRID V2 - 4 COLUMNS WITH GAPS AND NO OVERLAY */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-3.5 w-full max-w-[1640px] mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 animate-fade-in-up">
          {/* Shoe Care */}
          <div className="flex flex-col group">
            ...
            <div className="mt-5 flex flex-col items-center text-center">
              ...
              <LocalizedClientLink href="/categories/shoe-care">
                <button className="bg-[#0bb799] text-white px-8 py-2.5 rounded-full text-xs font-semibold uppercase tracking-wider shadow-sm hover:bg-[#099980] group-hover:shadow transition-all">Explore</button>
              </LocalizedClientLink>
            </div>
          </div>
