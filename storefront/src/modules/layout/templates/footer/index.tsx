        ...
        <div style={s.grid as any} className="responsive-grid-4">
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
            ...
            <div className="flex gap-3 mb-6">
              <a href="https://www.linkedin.com/company/mvshoecare" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" style={s.socialIcon as any} className="hover:bg-white hover:text-black transition-all">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z" /><rect x="2" y="9" width="4" height="12" /><circle cx="4" cy="4" r="2" /></svg>
              </a>
              <a href="https://www.facebook.com/profile.php?id=61592040394722" target="_blank" rel="noopener noreferrer" aria-label="Facebook" style={s.socialIcon as any} className="hover:bg-white hover:text-black transition-all">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" /></svg>
              </a>
              <a href="https://www.instagram.com/propremium_care/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" style={s.socialIcon as any} className="hover:bg-white hover:text-black transition-all">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5" /><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z" /><line x1="17.5" y1="6.5" x2="17.51" y2="6.5" /></svg>
              </a>
              <a href="https://www.youtube.com/@PROshoecare" target="_blank" rel="noopener noreferrer" aria-label="YouTube" style={s.socialIcon as any} className="hover:bg-white hover:text-black transition-all">
