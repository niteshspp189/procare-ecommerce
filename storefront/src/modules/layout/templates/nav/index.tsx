      ...
      <nav style={styles.mainNav as any}>
        ...
        <div style={styles.rightSection as any}>
          <div style={styles.searchContainer as any} className="hidden lg:flex group">
            <span className="absolute left-3 text-gray-400 group-focus-within:text-black transition-colors">
            ...
            <input
              ...
              className="search-input-premium bg-gray-50 rounded-full py-2.5 pr-6 text-sm outline-none w-[180px]"
            />
          </div>
